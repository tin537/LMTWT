...
def log_conversation(attacker_model: str, target_model: str, 
                     prompts: list, responses: list, 
                     success: bool, log_dir: Optional[str] = None) -> str:
    """
...
def print_attack_result(prompt: str, response: str, success: bool, reason: Optional[str] = None):
    """
